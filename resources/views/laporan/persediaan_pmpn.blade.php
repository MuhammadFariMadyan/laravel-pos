...
<div class="row">
  <div class="col-md-12">
      <div class="card">
          <div class="header"> 
              <h4 class="title">Laporan Persediaan<span class="pull-right"><a target="_blank" href={{Auth::user()->hasRole('penjaga') ? route('cetakpersediaan',['awal'=>$awal,'akhir'=>$akhir, 'id_barang'=> $id_barang]) : route('cetakpersediaanpm',['awal'=>$awal,'akhir'=>$akhir, 'id_barang'=> $id_barang])}} class="btn btn-xs btn-fill btn-success"><i class="fa fa-print"></i>Cetak</a></span></h4>
          </div>   
          <br>     
            <!-- <div class="col-md-10">                                                                     -->
              ...
              <table  class="table table-striped table-hover" id="dataTabelDataPersediaan">
                ...
                <tr>
                  ...
                  <td class="text-center">
                    {{ Form::open(['url' => route('cetakkartupersediaanpm', ['awal'=>$awal,'akhir'=>$akhir, 'id_barang'=> $persediaan->id_barang]), 'method' => 'get', 'class' => 'form-inline', 'target'=>'_blank']) }}
