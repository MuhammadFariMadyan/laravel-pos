...
<div class="row">
  <div class="col-md-12">
      <div class="card">
          <div class="header">
              <h4 class="title">Pembelian<span class="pull-right">&nbsp;<a href="{{route('tambahpembelian')}}" class="btn btn-xs btn-fill btn-info">Tambah Transaksi Pembelian</a></span><span class="pull-right"><a href="" class="btn btn-xs btn-fill btn-success"><i class="fa fa-print"></i>Cetak</a></span></h4>
          </div>
