    ...
    <div class="card">
      <div class="header">
        <h4 class="title">Penjualan<span class="pull-right">&nbsp;<a href="{{route('tambahpenjualan')}}" class="btn btn-xs btn-fill btn-info">Tambah Transaksi Penjualan</a></span><span class="pull-right">
          <!-- <a href="{{route('cetakpenjualan',$tanggal)}}" target="_blank" class="btn btn-xs btn-fill btn-success"><i class="fa fa-print"></i>Cetak</a> -->
        </span></h4>
      </div>
        ...
        <div class="col-md-12">
          <form class="form-inline" action="{{route('lihat_tanggalpenjualan')}}">
            <div class="form-group">
              ...
              <input type="date" name="tanggal" class="form-control input-sm" id="tanggal" value="{{$tanggal}}">
            </div>&nbsp;
        ...
        <table  class="table table-striped table-hover">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="text-center">{{toRupiah($penjualan->total_harga_jual)}}</td>
              <td class="text-center">{{toRupiah($penjualan->total_bayar)}}</td>
              <td class="text-center">{{toRupiah($penjualan->total_kembalian)}}</td>
