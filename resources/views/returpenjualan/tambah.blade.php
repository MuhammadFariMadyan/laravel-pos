@extends('layouts.app') @section('content-title', 'Tambah Retur Penjualan') @section('breadcrumb')
<ol class="breadcrumb">
  <li class="breadcrumb-item"><a href="{{route('datareturpenjualan')}}">Data Retur Penjualan</a></li>
...
<div class="row">
  <div class="col-md-12">
    <div class="card">
      <div class="header">
        <h4 class="title">Tambah Retur Penjualan<span class="pull-right"><a href="{{ URL::previous() }}" class="btn btn-xs btn-fill btn-info"><i class="fa fa-arrow-circle-left"></i>&nbsp;Kembali</a></span></h4>
        <p class="category">Silahkan masukkan data retur penjualan dengan benar..</p>
      </div>
      <div class="content">
        <form action="{{route('simpanreturpenjualan')}}" method="post">
          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="nama_penjaga" value="{{Auth::user()->name}}" readonly placeholder="" required>
              </div>
            </div>
          </div>
          <hr>
